          ...
          <AnimatePresence>
            ...
            >
              <div className="text-Justify-center">
                ...
                I feel so lucky to have you as my Spl Fav Person 💓. Hope your birthday is as special as you are 🤗.I am looking forward to many more years of our bond and birthdays with you💖. I am grateful that you are a part of my life🩷. In good times and bad, I’ll always be by your side 🩷✨</p>
                <div className="flex justify-center">
                  <motion.div
                    animate={{
                      scale: [1, 1.2, 1],
